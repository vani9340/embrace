...
<div class='capitalize  flex justify-between items-center pr-[6.9vw]'>
<div>
...
<div>
 ...
 py-[27.84px] '><img src={right}/>
</button>

</div>
</div>

<div class="container flex overflow-x-hidden py-0 mt-[53px] capitalize mb-[]">
  <div class="cards flex">

    <div class="card bg-blue_l w-[34vw] h-[296px] rounded-[30px] text-white">       
        <div class='pl-[2rem]'>
    ...
    <div class="card bg-[#F8F9FF] flex-shrink-0 w-[34vw] h-[296px] rounded-[30px] text-black ml-[20px]">       
    <div class='pl-[2rem]'>
    <div class='flex items-center mt-[2.5rem]' >
       <div>
        <img src={img2}/>
