...
function Part5(){
    return(
        <div className="min-h-[53.75rem] px-[6.9vw] flex flex-col items-center pt-[79px] pb-[83px] md:pb-0 md:min-h-[48rem]">
        ...
        <div class='md:flex justify-between mt-[50px]'>
            <div>
                <img src={laptop}/>
        ...
        <button class='bg-blue_l rounded-[64px]  py-[1rem] px-[3rem] mt-[3rem] text-white max-md:py-[0.5rem] max-md:px-[2.5rem]'>See More</button>
        </div>
    )
}
